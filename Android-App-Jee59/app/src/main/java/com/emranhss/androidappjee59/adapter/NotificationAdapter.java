package com.emranhss.androidappjee59.adapter;
...
import com.emranhss.androidappjee59.R;
...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.ViewHolder> {
    ...
    public NotificationAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(com.emranhss.androidappjee59.R.layout.notification_card, parent, false);
